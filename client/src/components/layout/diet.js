								...
								<Card border='secondary'>
									...
									<Card.Body className='bmibody'>
										<label className='citylabel'>
											► Underweight = BMI of <b>18.5</b> or less
										</label>
										<label className='citylabel'>
											► Normal Weight = <b>18.5-24.9</b>
										</label>
										<label className='citylabel'>
											► Over Weight = <b>25-29.9</b>
										</label>
										<label className='citylabel'>
											► Obesity = BMI of <b>30</b> or greater
										</label>
									</Card.Body>
								</Card>
								<br />
									...
									<thead>
										<tr>
											<th style={{ backgroundColor: 'teal' }}>
												<center>
													<label className='sidetable'>Age Range</label>
												</center>
											</th>
											<th style={{ backgroundColor: 'teal' }}>
												<center>
													<label className='sidetable'>
														Daily Calorie Range
													</label>
												</center>
											</th>
							...
							<Col>
								<Jumbotron className='Jumbotron'>
									<Container className='contin'>
										<center>
											<h2 className='sidetablee'>BMI Calculator</h2>
										</center>
										<hr />
										<Form.Row>
										...
										<center>
											<Button
												...
												onClick={async () => {
													...
													if (result < 18.5) {
														suggest =
															'You are Under weight, you need to gain weight.';
													} else if (result < 24.9) {
														suggest =
															'You have Normal weight. Gain/lose weight is not needed.';
													} else if (result < 29.9) {
														suggest =
															'You are Over weight, you need to lose weight';
													} else if (result > 30) {
														suggest =
								...
								<Jumbotron className='Jumbotron'>
									<center>
										<h2 className='sidetablee'>Calorie Intake Planner</h2>
									</center>
									<center>
										<p>(calculate BMI first to proceed)</p>
									</center>
									<hr />
									...
									<Form.Row>
										<Form.Group as={Col} controlId='formGridEmail'>
											...
											>
												...
												<option value='vactive'>
													Very Active: Intense exercise 6-7 times/week
												</option>
												<option value='eactive'>
										...
										<Button
											...
											onClick={async () => {
												...
												if (this.state.activity == 'sedentary') {
													var a = 1.2;
												} else if (this.state.activity == 'sedentary') {
													var a = 1.375;
										...
										<Card.Body style={{ backgroundColor: '#20B2AA' }}>
											<Card.Text>
												<Row>
													<Col>
														<center>
															<p className='outcomecal'>
																<b>To Lose Weight:</b>{' '}
																<h4>
																	<Badge variant='secondary'>
																		{this.state.losen} calories/day
																	</Badge>
																</h4>
															</p>
														</center>
													...
													<Col>
														<center>
															<p className='outcomecal'>
																<b>To Maintain Weight:</b>{' '}
																<h4>
																	<Badge variant='secondary'>
																		{this.state.cal} calories/day
																	</Badge>
																</h4>
															</p>
														</center>
									...
									<Row>
										<Col>
											<Form.Group controlId='exampleForm.ControlSelect1'>
												...
												>
													<option value={this.state.losen}>
														To Lose Weight
													</option>
													<option value={this.state.cal}>
														To Maintain Weight
													</option>
													<option value={this.state.gainn}>
														To Gain Weight
													</option>
												</Form.Control>
											</Form.Group>
									...
									<Card.ImgOverlay>
										<Row>
											<Col>
												...
												<center>
													{' '}
													<h3 className='dietcard'>
														<b>
															<u>Breakfast</u> <i class='fas fa-coffee'></i>
														</b>
													</h3>{' '}
												</center>
												<Card.Text>
											...
											<Col>
												...
												<center>
													<h3 className='dietcard'>
														<b>
															<u>Lunch</u> <i class='fas fa-hamburger'></i>
														</b>
													</h3>
												</center>
												<Card.Text>
										...
										<Row>
											<Col sm={2}></Col>
											<Col sm={3}>
												<h5 className='dietcard'>
													Snacks <i class='fas fa-apple-alt'>:</i>
												</h5>
											</Col>
											<Col sm={6}>
												<p className='dietP' style={{ textAlign: 'left' }}>
													{this.state.diet_plan.snack}
												</p>
											</Col>
											<Col sm={1}></Col>
										</Row>
