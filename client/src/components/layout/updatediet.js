...
const test = async () => {
  const z = await localStorage.getItem('Updateplan');
  Promise.all(z).then(alert("my object",localStorage.getItem('Updateplan')))
  ...
  return (
    <Fragment>
      ...
      <Container>
        ...
        <Col sm="3"></Col>
        <Col>
      <h1 className="large text-info"><b>Update Diet Plans</b></h1>
      <p className="lead"><i class="far fa-plus-square"></i> Update diet plans in database.</p>
      <form className="form" onSubmit={e => test()}>
        ...
        <center><b><input style={{width:"16em"}} type="submit" className="btn btn-info" value="Update" /></b></center>
      </form>
      <p className="my-1">
         </p>
         </Col>
