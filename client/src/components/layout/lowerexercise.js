...
class Lowerexercise extends Component {
    ...
    render() {
        return (
            <div>
                ...
                <br/>
                <center><h2><i class="fas fa-volleyball-ball"></i> Lower Body Workouts <i class="fas fa-volleyball-ball"></i></h2></center>
                <hr/>
                <Container>
                    <Row>
                        <Col sm={2}>
